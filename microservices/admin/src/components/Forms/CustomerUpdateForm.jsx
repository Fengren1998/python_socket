...
class CustomerUpdateForm extends PureComponent {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    updateCustomer(firstName, lastName, email, password);
  }
...
CustomerUpdateForm.defaultProps = {
  error: null,
};
...
export default withStyles(styles)(CustomerUpdateForm);
