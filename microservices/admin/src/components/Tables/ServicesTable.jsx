...
class ServiceTableHead extends Component {
        ...
        <div className={classes.actions}>
          {numSelected > 0 ? (
            <Fragment>
              ...
              {numSelected === 1 && (
                <Tooltip title="Update">
                  <Link className={classes.linkButton} to={`/services/update?id=${selected[0]}`}>
            ...
            <Tooltip title="Add Service">
              <Link className={classes.linkButton} to="/services/add">
...
ServiceTableToolbar.defaultProps = {
  error: null,
};
...
ServiceTableToolbar = withStyles(toolbarStyles)(ServiceTableToolbar);
...
class ServiceTable extends Component {
  ...
  handleSelectAllClick = (event) => {
    ...
    if (event.target.checked) {
      this.setState({ selected: createData(services).map(n => n.id) });
      return;
    }
  ...
  handleDelete = async () => {
    ...
    await ServiceAPI.deleteService(ids);
  ...
  render() {
    const { classes, services, error } = this.props;
    const {
      order,
      orderBy,
      selected,
    ...
    const data = createData(services);
